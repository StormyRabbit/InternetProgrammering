...
function openMySQLWindow(_import) {
    mainWindow.getElementById('popup').style.display = "block";
    ...
    submenu: [
      ...
      },
      {
        ...
        click() {
          dialog.showOpenDialog(
              {
                  properties: ['openFile']}, loadEncryptedXML);
        },
      },
      {label: 'MySQL',
      click() {
          openMySQLWindow(true)
        },
      },
    ],
  },
